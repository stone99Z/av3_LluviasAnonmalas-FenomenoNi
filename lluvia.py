...
plan_contingencia = st.selectbox(label="", options=['Opción 1', 'Opción 2'], index=0)
...
simulacros_educativa = st.selectbox(label="", options=['Opción 1', 'Opción 2'], index=0)
...
zona_riesgo = st.selectbox(label="", options=['Opción 1', 'Opción 2'], index=0)
...
mejoras_infraestructura = st.selectbox(label="", options=['Opción 1', 'Opción 2'], index=0)

st.write('**[10] ¿La institución educativa cuenta con un sistema de evacuación en caso de deslizamientos e inundaciones?**')
evacuacion = st.selectbox(label="", options=['Opción 1', 'Opción 2'], index=0)

def main():
    if st.button("**EJECUTAR**"):
        resultado = ''
        if (plan_contingencia == 'Opción 1' and simulacros_educativa == 'Opción 1' and infraestructura == 'Opción 1' and 
            personal_capacitado == 'Opción 1' and comunidad_informada == 'Opción 1' and acceso_recursos == 'Opción 1' and 
            alerta_temprana == 'Opción 1' and zona_riesgo == 'Opción 1' and mejoras_infraestructura == 'Opción 1' and 
            evacuacion == 'Opción 1'):
